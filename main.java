...
public class main {
	...
	public static void main(String[] args) {
		...
		int choice;
		do {
			System.out.println("------------CustomerDetails AND AtmProcess------------");
   ...
   static void atmoperation() {
	...
	static void loadcash() {
	    ...
	    System.out.println("Enter cash count->");
	    System.out.println("Enter count-2000");
	    int _2000=sc.nextInt();
	    System.out.println("Enter count-500");
	    int _500=sc.nextInt();
	    System.out.println("Enter count-100");
	    int _100=sc.nextInt();
